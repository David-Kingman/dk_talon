# This is customized to add a new "snap middle" command compared to the version of this file in vanilla community
...
_snap_positions = {
    ...
    "middle": RelativeScreenPos(0.1, 0.05, 0.9, 0.95),
